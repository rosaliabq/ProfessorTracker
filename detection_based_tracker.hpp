...
class DetectionBasedTracker
{
    public:
        ...
        virtual void process(const cv::Mat& imageGray, const cv::Mat& mask);
    ...
    protected:
        ...
        void detectInRegion(const cv::Mat& img, const cv::Mat& mask, const cv::Rect& r, std::vector<cv::Rect>& detectedObjectsInRegions);
};
